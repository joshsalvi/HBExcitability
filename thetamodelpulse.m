function [Xdet, Xsto, Fext] = thetamodelpulse(I,thetaNoiseSTD,tvec,Fextmax,pulsestart,pulseend)
%
...
% theta model. 
%
% [Xdet, Xsto, Fext] = thetamodelpulse(I,thetaNoiseSTD,tvec,Fextmax,pulsestart,pulseend)
%
