function [Xdet, Xsto, Fext] = subhopfstochpulse(mu,omega,xNoiseSTD,yNoiseSTD,tvec,Fextmax,pulsestart,pulseend)
%
...
%
% [Xdet, Xsto, Fext] = subhopfstochpulse(mu,omega,xNoiseSTD,yNoiseSTD,tvec,Fextmax,pulsestart,pulseend)
%
