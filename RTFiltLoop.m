...
dir_in = '/Users/joshsalvi/Documents/Lab/Lab/Clamp Data/2014-02-21.01/Ear 1/Cell 2/20140221-cell2.mat';
...
dir_out = '/Users/joshsalvi/Downloads/output/20140221-cell5-Fp16-kp1-';

% input operating point
Fp = 16;        % force index (CHOOSE)
...
[upt{Fp,kp}, downt{Fp,kp}, ~,RTupexp_p5(1,Fp,kp),RTupgauss_p5(1:3,Fp,kp),RTdownexp_p5(1,Fp,kp),RTdowngauss_p5(1:3,Fp,kp),RTupexp_stat5(1,Fp,kp),RTdownexp_stat5(1:3,Fp,kp),RTupgauss_stat5(1:3,Fp,kp),RTdowngauss_stat5(1:3,Fp,kp),RTuppoisschistat_p5(:,Fp,kp),RTuppoisschi_stat5(:,Fp,kp),RTuppoisschi_p5(:,Fp,kp),RTdownpoisschi_p5(:,Fp,kp)]=RTfilt('a.mat',Fp,kp,win_in,freq_in,Fs,1,outfile,minT_in,1,0,offsetyn,offset);
else
    disp('RTfilt() and Save: OFF');
end
...
disp('Saving...');
save(sprintf('%s%s',file,'-stats_all.mat'),'RTupexp_p5','RTupgauss_p5','RTdownexp_p5','RTdowngauss_p5','RTupexp_stat5','RTdownexp_stat5','RTupgauss_stat5','RTdowngauss_stat5','win_in','freq_in','minT_in','down_eventsall','up_eventsall','RTuppoisschistat_p5','RTuppoisschi_stat5','RTuppoisschi_p5','RTdownpoisschi_p5','RTuppoisschi_stat5');
disp('Finished.');
