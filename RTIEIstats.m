...
display('Importing...');
load('/Users/joshsalvi/Documents/Lab/Lab/Simulation Data/Sinusoids/whitenoisemovingavg_concwins2_exp.mat');
%load('/Users/joshsalvi/Documents/Lab/Lab/Simulation Data/ONHFishJosh/Analysis/Fp7-kp2-start1end2e5-xfish1.0Noise-movingavg_concwins2.mat');
warning off;
...
if nbinsup > 1e6
    nbinsup = 1e6;
else if isempty(nbinsup) == 1 | isnan(nbinsup) ==1
        nbinsup=2;
    end
end
...
if nbinsdown > 1e6
    nbinsdown = 1e6;
else if isempty(nbinsdown) == 1 | isnan(nbinsdown) ==1
        nbinsdown=2;
    end
end
...
if nbinsupiei > 1e6
    nbinsupiei = 1e6;
else if isempty(nbinsupiei) == 1 | isnan(nbinsupiei) ==1
        nbinsupiei=2;
    end
end
...
if nbinsdowniei > 1e6
    nbinsdowniei = 1e6;
else if isempty(nbinsdowniei) == 1 | isnan(nbinsdowniei) ==1
        nbinsdowniei=2;
    end
end
...
if nbinsbufferiei > 1e6
    nbinsbufferiei = 1e6;
else if isempty(nbinsbufferiei) == 1 | isnan(nbinsbufferiei) ==1
        nbinsbufferiei=2;
    end
end
...
if nbinsbuffer > 1e6
    nbinsbuffer = 1e6;
else if isempty(nbinsbuffer) == 1 | isnan(nbinsbuffer) ==1
        nbinsbuffer=2;
    end
end
...
display('Saving...');
save('/Users/joshsalvi/Documents/Lab/Lab/Simulation Data/Sinusoids/whitenoisemovingavg_concwins2_exp_stats2.mat','RTupexp_p','RTupgauss_p','RTdownexp_p','RTdowngauss_p','RTbufferexp_p','RTbuffergauss_p','IEIdownexp_p','IEIdowngauss_p','IEIupexp_p','IEIupgauss_p','IEIbufferexp_p','IEIbuffergauss_p');
%save('/Users/joshsalvi/Documents/Lab/Lab/Simulation Data/ONHFishJosh/Analysis/Fp7-kp2-start1end2e5-xfish1.0Noise-movingavg_concwins2_stats.mat','RTupexp_p','RTupgauss_p','RTdownexp_p','RTdowngauss_p','RTbufferexp_p','RTbuffergauss_p','IEIdownexp_p','IEIdowngauss_p','IEIupexp_p','IEIupgauss_p','IEIbufferexp_p','IEIbuffergauss_p');
display('Finished.');
